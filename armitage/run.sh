#!/bin/bash
# Borrowed from https://github.com/jfrazelle/dockerfiles/blob/master/metasploit/start.sh
set -e
...
java -Djavax.net.ssl.keyStore=./armitage.store -Djavax.net.ssl.keyStorePassword=123456 -server -XX:+UseParallelGC -jar /usr/share/armitage/armitage.jar --server $1 55554 msf $2 55553
